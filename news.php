...
$pageTitle = 'Новости';
$pageDescription = 'Новости магазина AmanitaLove: акции, поступления, события.';
$canonicalUrl = 'https://amanitalove.ru/news';
?>
<!DOCTYPE html>
...
<body>
    ...
    <main class="py-12 px-4 max-w-7xl mx-auto">
        <h1 class="text-3xl md:text-4xl font-black mb-2 text-[var(--text-primary)]">📰 Новости</h1>
        <p class="text-[var(--text-secondary)] mb-8">Актуальные события AmanitaLove: анонсы, акции и обновления.</p>
        <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6" id="newsFullGrid"></div>
    </main>
